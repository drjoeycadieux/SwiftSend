...
import { Send, Zap, ShieldCheck, Bot } from 'lucide-react';
          ...
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl font-headline">Why Choose SwiftSend?</h2>
            ...
            <div className="mx-auto grid max-w-5xl items-center gap-6 py-12 lg:grid-cols-3 lg:gap-12">
              ...
              <div className="grid gap-1 text-center">
                ...
                <p className="text-muted-foreground">
                  Get smart emoji suggestions to add a personal touch to your transfers.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="container grid items-center justify-center gap-4 px-4 text-center md:px-6">
            <div className="space-y-3">
              ...
              <p className="mx-auto max-w-[600px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                Join thousands of satisfied users. Create your account in minutes and start sending money securely.
              </p>
            </div>
